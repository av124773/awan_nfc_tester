...
/*Add enum definitions to for Windows DLL*/
/*typedef struct
{
	uint16_t cmd_len;
	uint8_t *p_cmd;
...
enum {
	...
	HAL_NFC_STATUS_INVALID_FW = 0x05
};
/*
enum {
	HAL_NFC_IOCTL_GET_CONFIG_INFO = 3,
	HAL_NFC_IOCTL_CHECK_FLASH_REQ,
	HAL_NFC_IOCTL_FW_DWNLD,
	HAL_NFC_IOCTL_FW_MW_VER_CHECK,
	HAL_NFC_IOCTL_FORCED_FW_DWNLD = 8,
	HAL_NFC_IOCTL_CHIP_TYPE_CHECK
};
*/
/**End of enum defination added for windows architecture)**/
...
#if 0 //In Windows, below part is not needed
/*
